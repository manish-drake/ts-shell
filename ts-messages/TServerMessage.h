...
class TServerMessage
{
  ...
  public:
    ...
    template <bool>
    std::vector<bool> write(const char *, std::vector<bool> &arr);
    template <int>
    std::vector<int> write(const char *, std::vector<int> &arr);
    template <short int>
    std::vector<int> write(const char *, std::vector<int> &arr);
    template <unsigned int>
    std::vector<unsigned int> write(const char *, std::vector<unsigned int> &arr);
    template <short unsigned int>
    std::vector<unsigned int> write(const char *, std::vector<unsigned int> &arr);
    template <long long int>
    std::vector<long long> write(const char *, std::vector<long long int> &arr);
    template <float &>
    std::vector<float> write(const char *, std::vector<float> &arr);
    template <double &>
    std::vector<double> write(const char *, std::vector<double> &arr);
    template <std::string &>
    std::vector<std::string> write(const char *, std::vector<std::string> &arr);
